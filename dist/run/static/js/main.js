...
exports$2 = ReactPropTypesSecret$1;
var _ReactPropTypesSecret = exports$2;
var exports$11 = {};
exports$11 = Function.call.bind(Object.prototype.hasOwnProperty);
var _has = exports$11;
var exports1 = {};
...
exports1 = checkPropTypes;
var _checkPropTypes = exports1;
var exports2 = {};
(function() {
    'use strict';
    var _assign = exports$1;
    var checkPropTypes = _checkPropTypes;
...
exports2.Children, exports2.Component, exports2.Fragment, exports2.Profiler, exports2.PureComponent, exports2.StrictMode, exports2.Suspense, exports2.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED, exports2.cloneElement, exports2.createContext, exports2.createElement, exports2.createFactory, exports2.createRef, exports2.forwardRef, exports2.isValidElement, exports2.lazy, exports2.memo, exports2.useCallback, exports2.useContext, exports2.useDebugValue, exports2.useEffect, exports2.useImperativeHandle, exports2.useLayoutEffect, exports2.useMemo, exports2.useReducer, exports2.useRef, exports2.useState, exports2.version;
const Children = exports2.Children, Component = exports2.Component, Fragment = exports2.Fragment, Profiler = exports2.Profiler, PureComponent = exports2.PureComponent, StrictMode = exports2.StrictMode, Suspense = exports2.Suspense, __SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = exports2.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED, cloneElement = exports2.cloneElement, createContext = exports2.createContext, createElement = exports2.createElement, createFactory = exports2.createFactory, createRef = exports2.createRef, forwardRef = exports2.forwardRef, isValidElement = exports2.isValidElement, lazy = exports2.lazy, memo = exports2.memo, useCallback = exports2.useCallback, useContext = exports2.useContext, useDebugValue = exports2.useDebugValue, useEffect = exports2.useEffect, useImperativeHandle = exports2.useImperativeHandle, useLayoutEffect = exports2.useLayoutEffect, useMemo = exports2.useMemo, useReducer = exports2.useReducer, useRef = exports2.useRef, useState = exports2.useState, version = exports2.version;
const mod = {
    default: exports2,
    Children,
    Component,
...
(function() {
    ...
    if (typeof window === "undefined" || typeof MessageChannel !== "function") {
        ...
        var performance1 = window.performance;
        ...
        if (typeof performance1 === "object" && typeof performance1.now === "function") {
            exports3.unstable_now = function() {
    ...
    function flushWork(hasTimeRemaining, initialTime) {
        ...
        try {
            ...
            {
                var _currentTime = exports3.unstable_now();
    ...
    exports3.unstable_shouldYield = unstable_shouldYield;
    exports3.unstable_wrapCallback = unstable_wrapCallback;
})();
exports3.unstable_now, exports3.unstable_forceFrameRate, exports3.unstable_IdlePriority, exports3.unstable_ImmediatePriority, exports3.unstable_LowPriority, exports3.unstable_NormalPriority, exports3.unstable_Profiling, exports3.unstable_UserBlockingPriority, exports3.unstable_cancelCallback, exports3.unstable_continueExecution, exports3.unstable_getCurrentPriorityLevel, exports3.unstable_getFirstCallbackNode, exports3.unstable_next, exports3.unstable_pauseExecution, exports3.unstable_requestPaint, exports3.unstable_runWithPriority, exports3.unstable_scheduleCallback, exports3.unstable_shouldYield, exports3.unstable_wrapCallback;
var exports4 = {};
(function() {
    'use strict';
    ...
    exports4.__interactionsRef = null;
    exports4.__subscriberRef = null;
    {
        exports4.__interactionsRef = {
            current: new Set()
        };
        exports4.__subscriberRef = {
            current: null
        };
    }
    function unstable_clear(callback) {
        var prevInteractions = exports4.__interactionsRef.current;
        exports4.__interactionsRef.current = new Set();
        try {
            return callback();
        } finally{
            exports4.__interactionsRef.current = prevInteractions;
        }
    }
    function unstable_getCurrent() {
        {
            return exports4.__interactionsRef.current;
        }
    }
    ...
    function unstable_trace(name, timestamp, callback) {
        ...
        exports4.__interactionsRef.current = interactions;
        var subscriber = exports4.__subscriberRef.current;
        var returnValue;
        try {
            if (subscriber !== null) {
    ...
    function unstable_wrap(callback) {
        ...
        var wrappedInteractions = exports4.__interactionsRef.current;
        var subscriber = exports4.__subscriberRef.current;
        if (subscriber !== null) {
        ...
        function wrapped() {
            var prevInteractions = exports4.__interactionsRef.current;
            exports4.__interactionsRef.current = wrappedInteractions;
            subscriber = exports4.__subscriberRef.current;
            try {
                var returnValue;
                try {
                    if (subscriber !== null) {
    ...
    function unstable_subscribe(subscriber) {
        {
            ...
            if (subscribers.size === 1) {
                exports4.__subscriberRef.current = {
    ...
    function unstable_unsubscribe(subscriber) {
        {
            ...
            if (subscribers.size === 0) {
                exports4.__subscriberRef.current = null;
            }
        }
    }
    ...
    exports4.unstable_clear = unstable_clear;
    exports4.unstable_getCurrent = unstable_getCurrent;
    exports4.unstable_getThreadID = unstable_getThreadID;
    exports4.unstable_subscribe = unstable_subscribe;
    exports4.unstable_trace = unstable_trace;
    exports4.unstable_unsubscribe = unstable_unsubscribe;
    exports4.unstable_wrap = unstable_wrap;
})();
exports4.__interactionsRef, exports4.__subscriberRef, exports4.unstable_clear, exports4.unstable_getCurrent, exports4.unstable_getThreadID, exports4.unstable_subscribe, exports4.unstable_trace, exports4.unstable_unsubscribe, exports4.unstable_wrap;
var exports5 = {};
(function() {
    'use strict';
    var React = exports2;
    var _assign = exports$1;
    var Scheduler = exports3;
    var checkPropTypes = _checkPropTypes;
    var tracing = exports4;
    ...
    function eagerlyTrapReplayableEvents(container, document1) {
        var listenerMapForDoc = getListenerMapForElement(document1);
    ...
    exports5.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = Internals;
    exports5.createPortal = createPortal$1;
    exports5.findDOMNode = findDOMNode;
    exports5.flushSync = flushSync;
    exports5.hydrate = hydrate;
    exports5.render = render;
    exports5.unmountComponentAtNode = unmountComponentAtNode;
    exports5.unstable_batchedUpdates = batchedUpdates$1;
    exports5.unstable_createPortal = unstable_createPortal;
    exports5.unstable_renderSubtreeIntoContainer = renderSubtreeIntoContainer;
    exports5.version = ReactVersion;
})();
exports5.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED, exports5.createPortal, exports5.findDOMNode, exports5.flushSync, exports5.hydrate, exports5.render, exports5.unmountComponentAtNode, exports5.unstable_batchedUpdates, exports5.unstable_createPortal, exports5.unstable_renderSubtreeIntoContainer, exports5.version;
const __SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED1 = exports5.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED, createPortal = exports5.createPortal, findDOMNode = exports5.findDOMNode, flushSync = exports5.flushSync, hydrate = exports5.hydrate, render = exports5.render, unmountComponentAtNode = exports5.unmountComponentAtNode, unstable_batchedUpdates = exports5.unstable_batchedUpdates, unstable_createPortal = exports5.unstable_createPortal, unstable_renderSubtreeIntoContainer = exports5.unstable_renderSubtreeIntoContainer, version1 = exports5.version;
const mod1 = {
    default: exports5,
...
function App() {
    return react.createElement(react.Fragment, null, react.createElement("link", {
        ...
        className: "App-logo",
        alt: "logo"
    }), react.createElement("p", null, "Test deploy deno-create-react-app"), react.createElement("a", {
        className: "App-link",
